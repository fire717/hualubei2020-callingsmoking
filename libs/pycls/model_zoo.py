...
# import .builders as builders
# import .checkpoint as cp
from .builders import *
from .checkpoint import *
from .config import cfg, reset_cfg
...
_DOWNLOAD_CACHE = "../model"#r"F:\Workshop\hualubei\HLB_partB\model"
...
def get_config_file(name):
    ...
    # config_url = os.path.join(_URL_CONFIGS, os.path.basename(_MODEL_ZOO_CONFIGS[name]))
    # return cache_url(config_url, _DOWNLOAD_CACHE, _URL_CONFIGS)
    return _DOWNLOAD_CACHE+"/"+os.path.basename(_MODEL_ZOO_CONFIGS[name])
...
def build_model(name, pretrained=False, cfg_list=()):
    ...
    if pretrained:
        ...
        load_checkpoint(weights_file, model)
    return model
