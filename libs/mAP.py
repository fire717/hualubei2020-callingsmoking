...
if __name__ == "__main__":
    ...
    result_json_path = '../save/result.json'#'data/output/v3_xpt_224/result.json'
    classname_list = [ 'calling', 'normal', 'smoking','smoking_calling']
    label_json_path = '../../data/val.json'

    mAP = get_test_mAP(result_json_path, classname_list, label_json_path)
    print("mAP: ", mAP)
